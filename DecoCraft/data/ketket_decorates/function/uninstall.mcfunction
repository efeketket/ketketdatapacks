...
tellraw @a ["","[DecoCraft]",{"text":" Datapack successfully uninstalled. All DecoCraft materials cleared from loaded chunks. You can safely disable datapack.","color":"dark_green"}]