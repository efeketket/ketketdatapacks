item replace entity @e[type=hopper_minecart,tag=ket.npc,tag=holder,sort=nearest,limit=1] container.0 from entity @e[tag=this,type=mannequin,sort=nearest,limit=1,tag=ket.npc] armor.chest
item replace entity @e[tag=this,type=mannequin,sort=nearest,limit=1,tag=ket.npc] armor.chest from entity @s weapon.mainhand
