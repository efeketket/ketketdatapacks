title @s actionbar {text:"Mode : Fortune",color:"dark_green"}
...
data remove entity @e[tag=ket.sfs,type=hopper_minecart,sort=nearest,limit=1] Items[0].components.minecraft:enchantments.minecraft:silk_touch
data modify entity @e[tag=ket.sfs,type=hopper_minecart,sort=nearest,limit=1] Items[0].components.minecraft:enchantments.minecraft:fortune set value 3
