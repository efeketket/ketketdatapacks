...
execute as @s[tag=2] run particle dust{color:[0.64,0.26,0.9],scale:1} ~ ~0.3 ~ 0.2 0.2 0.2 0 1
execute as @s[tag=3] run particle dust{color:[0.30,0.40,0.9],scale:1} ~ ~0.3 ~ 0.2 0.2 0.2 0 1
