...
execute store success score @s ket.bool run data get entity @s SelectedItem.components."minecraft:stored_enchantments"."minecraft:wind_burst"

execute if score @s ket.bool matches 1 run data modify storage ket.lectern holders.currentEnch set value "minecraft:wind_burst"
execute if score @s ket.bool matches 1 run data modify storage ket.lectern holders.currentLevel set from entity @s SelectedItem.components."minecraft:stored_enchantments"."minecraft:wind_burst"
