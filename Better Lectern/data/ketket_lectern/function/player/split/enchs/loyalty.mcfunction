...
execute store success score @s ket.bool run data get entity @s SelectedItem.components."minecraft:stored_enchantments"."minecraft:loyalty"

execute if score @s ket.bool matches 1 run data modify storage ket.lectern holders.currentEnch set value "minecraft:loyalty"
execute if score @s ket.bool matches 1 run data modify storage ket.lectern holders.currentLevel set from entity @s SelectedItem.components."minecraft:stored_enchantments"."minecraft:loyalty"
