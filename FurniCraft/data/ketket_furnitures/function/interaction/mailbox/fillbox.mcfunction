...
execute if score @e[type=interaction,sort=nearest,limit=1] mailstoragecounter matches 1 run data modify entity @e[type=minecraft:item_display,limit=1,sort=nearest] item.components."minecraft:custom_data".Storage[0] set from entity @s SelectedItem
execute if score @e[type=interaction,sort=nearest,limit=1] mailstoragecounter matches 2 run data modify entity @e[type=minecraft:item_display,limit=1,sort=nearest] item.components."minecraft:custom_data".Storage[1] set from entity @s SelectedItem
execute if score @e[type=interaction,sort=nearest,limit=1] mailstoragecounter matches 3 run data modify entity @e[type=minecraft:item_display,limit=1,sort=nearest] item.components."minecraft:custom_data".Storage[2] set from entity @s SelectedItem
execute if score @e[type=interaction,sort=nearest,limit=1] mailstoragecounter matches 4 run data modify entity @e[type=minecraft:item_display,limit=1,sort=nearest] item.components."minecraft:custom_data".Storage[3] set from entity @s SelectedItem
execute if score @e[type=interaction,sort=nearest,limit=1] mailstoragecounter matches 5 run data modify entity @e[type=minecraft:item_display,limit=1,sort=nearest] item.components."minecraft:custom_data".Storage[4] set from entity @s SelectedItem
