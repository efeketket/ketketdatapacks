execute positioned ~ ~1 ~ if block ~ ~ ~ player_head run summon minecraft:item_frame ~ ~-1 ~ {Tags:["sumshop"]}
execute positioned ~ ~-1 ~ if block ~ ~ ~ player_wall_head run summon minecraft:item_frame ~ ~-1 ~ {Tags:["sumshop"]}
execute positioned ~ ~-1 ~ if block ~ ~ ~ player_head run summon minecraft:item_frame ~ ~-1 ~ {Tags:["sumshop"]}
execute positioned ~ ~-1 ~ if block ~ ~ ~ player_wall_head run summon minecraft:item_frame ~ ~-1 ~ {Tags:["sumshop"]}
execute if block ~ ~ ~ player_head run summon minecraft:item_frame ~ ~-1 ~ {Tags:["sumshop"]}
execute if block ~ ~ ~ player_wall_head run summon minecraft:item_frame ~ ~-1 ~ {Tags:["sumshop"]}
