...
data modify entity @s[tag=pricetext] text set value '["","x",{"score":{"name":"@s","objective":"product_pricedisp"}}]'
data modify entity @s[tag=producttext] text set value '["","x",{"score":{"name":"@s","objective":"product_countdisp"}}]'
