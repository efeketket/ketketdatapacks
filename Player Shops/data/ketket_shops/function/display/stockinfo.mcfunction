...
execute if data entity @e[type=item_display,sort=nearest,limit=1,tag=shopdata] item.components."minecraft:custom_data".Product.components."minecraft:custom_data".StoredEnchantments run function ketket_shops:display/iteminfodisp/storedenchantments
